...
public class ExifInterface {
	 ...
	 * @since EXIF 2.3
	 * @see ExifUtil#processLensSpecifications(Rational[])
	 */
	 ...
	 * @param options bit flag which defines which type of tags to process, see {@link Options}
	 * @see #readExif(InputStream, int)
	 * @throws IOException
	 */
	@SuppressWarnings( "unused" )
	...
	/**
	 * Options for calling {@link #readExif(InputStream, int)}, {@link #readExif(byte[], int)},
